	...
	if global.version < 3 then
		for a, b in pairs(global.turbines) do
			if b.base and b.base.valid then
				...
				b.turbine = rendering.draw_animation { animation = "ownly_wind_turbine_mk" .. b.level .. "_" .. b.orientation,
					target = { b.base.position.x, b.base.position.y - 10 }, surface = b.base.surface,
					animation_speed = b.base.surface.wind_speed * WIND_SPEED_MULT }
				b.shadow = rendering.draw_animation { animation = "ownly_wind_turbine_shadow_" .. b.orientation,
					target = { b.base.position.x + 6, b.base.position.y - 1 }, surface = b.base.surface,
					animation_speed = b.base.surface.wind_speed * WIND_SPEED_MULT }
...
function entity_built(event)
	...
	global.turbines[new_entity.unit_number] = {
		...
		orientation = 16,
		level = level,
		turbine = rendering.draw_animation { animation = "ownly_wind_turbine_mk" .. level .. "_" .. orientation,
			target = { position.x, position.y - 10 }, surface = surface, animation_speed = surface.wind_speed * WIND_SPEED_MULT,
			render_layer = "wires-above" },
		shadow = rendering.draw_animation { animation = "ownly_wind_turbine_shadow_" .. orientation,
			target = { position.x + 6, position.y - 1 }, surface = surface, animation_speed = surface.wind_speed * WIND_SPEED_MULT },
